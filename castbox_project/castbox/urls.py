...
urlpatterns = [
    ...
    path("channel/<int:channel_id>/episode/<int:pk>/play/", EpisodePlayView.as_view(), name="episode_play"),
    ...
    path("channel/<int:channel_id>/episode/<int:pk>/select-playlist/", EpisodeSelectPlaylistView.as_view(), name="episode_select_playlist"),
    ...
    path("profile/<int:profile_id>/channel/<int:channel_id>/comment/<int:pk>/", ProfileCommentDetailView.as_view(), name="profile_comment_detail"),
    path("profile/<int:profile_id>/channel/<int:channel_id>/comment/<int:pk>/edit/", ProfileCommentUpdateView.as_view(), name="profile_comment_edit"),
    path("profile/<int:profile_id>/channel/<int:channel_id>/comment/<int:pk>/delete/", ProfileCommentDeleteView.as_view(), name="profile_comment_delete"),
